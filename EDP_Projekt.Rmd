...
Ponieważ wartość p jest bardzo mała (1.128e-05), odrzucono hipotezę zerową, która mówi, że modele są zgodne. To sugeruje, że model efektów stałych (FE) jest bardziej odpowiedni niż model efektów losowych (RE) w tym przypadku.
